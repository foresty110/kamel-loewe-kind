...
/**
 * 게시글 상세조회 시 게시글에 속한 첨부파일 정보를 담은 응답 DTO
 */
@Getter
@Builder
public class AttachmentDetailResponseDto {
     ...
     * @return 변환된 응답 DTO
     */
    public static AttachmentDetailResponseDto from(Attachment attachment) {
        return AttachmentDetailResponseDto.builder()
                .id(attachment.getId())
